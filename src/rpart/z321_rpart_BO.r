...
ksemilla_azar  <- 14293   #cambiar por la primer semilla
...
setwd("C:/Users/Julieta/OneDrive/MCD/segundo_año/Laboratorio_de_Implementacion_I\\labo\\exp\\HT3210\\")   #Establezco el Working Directory DEL EXPERIMENTO
